...
class User(SQLModel, table=True):
    ...
    username: Optional[str] = Field(default=None, index=True, unique=True, nullable=True, max_length=50)
    ...
    passport: Optional[str] = Field(default="", max_length=9, unique=True)  # None bo'lsa keyinchalik update qilinadi
